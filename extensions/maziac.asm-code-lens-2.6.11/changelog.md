...
# 2.6.11
- Fix for [#6](https://github.com/maziac/asm-code-lens-issues/issues/6): language id extensions are case insensitive now.

# 2.6.10
- Fix for [#5](https://github.com/maziac/asm-code-lens-issues/issues/5): Outline view now shows local labels again.
- Refactored asm-collection an asm-collection-list.

# 2.6.9
- Link updated

# 2.6.8
- Fix for [#4](https://github.com/maziac/asm-code-lens-issues/issues/4): Performance improvements.
